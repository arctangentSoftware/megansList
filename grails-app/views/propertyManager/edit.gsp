...
<html>
    ...
    <body>
        <a href="#edit-propertyManager" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-propertyManager" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.propertyManager}" method="PUT">
