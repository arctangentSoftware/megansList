...
<html>
    ...
    <body>
        ...
        <div id="show-property" class="content scaffold-show" role="main">
            ...
            <f:display bean="property" />
            <g:form resource="${this.property}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.property}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
